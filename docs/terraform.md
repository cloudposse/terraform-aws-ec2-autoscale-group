...
| <a name="input_tag_specifications_resource_types"></a> [tag\_specifications\_resource\_types](#input\_tag\_specifications\_resource\_types) | List of tag specifications resource types for the launch template | `list(string)` | <pre>[<br>  "elastic-gpu",<br>  "instance",<br>  "spot-instances-request",<br>  "volume"<br>]</pre> | no |
