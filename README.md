...
| <a name="input_update_default_lt_version"></a> [update\_default\_lt\_version](#input\_update\_default\_lt\_version) | Whether to update Default version of Launch template each update | `bool` | `false` | no |
