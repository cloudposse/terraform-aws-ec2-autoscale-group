...
module "autoscale_group" {
  ...
  ## Mixed Type
  mixedspot_asg = var.mixedspot_asg
  mixedspot_instance_distribution = var.mixedspot_instance_distribution
  mixedspot_instance_types  = var.mixedspot_instance_types
